...
### 1.1.1 Functional Requirements
 ...
 - The resource threshold limit should be drived from resource configuration
 - Resource monitoring interval should be derived from the system platfrom configration
 -  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjk1MzYwOTMwLC0xODM3NzcxMTQ0LDE0Nj
