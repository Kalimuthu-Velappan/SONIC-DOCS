...
The tech-support data is a system vital information for debugging and generated by collecting the  device configuration, system information, log files  and core files. The tech-support export service generates the tech-support data and export it to an remote server for better offline debugging.  The tech-support data is generated and exported on the following conditions 

  1.  On detection of a new core file, “tech-support” data is captured and exported.
  2.  On Periodically captured and exported.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1MjA1NzYzLDE3MDM4NTg2MDIsLTE1Nj
YxNjczMjMsNjA3MTA3NzA1LC05ODE0MTM0NjUsLTE5NzU2Nzk2
NTcsLTEyODkyODUzODQsLTIwMTg5MzUzMTgsLTE2ODc2NjcwNT
gsMTkxMDY0NTgwMV19
-->