...
The tech-support data is a system vital information for debugging which includes device configuration, system information, log files  and core files. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI0OTAyMDk5LDE3MDM4NTg2MDIsLTE1Nj
