...
3| export service | 1. List the export servic info <br> -- show export <br> 2. Verify the coonfig db by show running config <br> -- show runningconfiguration all | Pass
4| 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjUyODMyOTksLTE1NTYxNzQ2MDYsMT
